      ...
      <div id='graph-buttons'>
        <div id='set-times-container' key='set'>
          <div
            ...
            type="button"
            className="button"
            onClick={(event) => this.clickSetButton(event, 10*365)}
          >Last 10 Years</div>
          <div
            id='last-5-years' 
            key='last-5-years'
            type="button"
            className="button"
            onClick={(event) => this.clickSetButton(event, 5*365)}
          >Last 5 Years</div>
          <div
            id='last-year' 
            key='last-year'
            type="button"
            className="button"
            onClick={(event) => this.clickSetButton(event, 365)}
          >Last Year</div>
          <div
            id='last-6-months' 
            key='last-6-months'
            ...
            onClick={(event) => this.clickSetButton(event, 183)}
          >Last 6 Months</div>
          <div
            id='last-month' 
            key='last-month'
            type="button"
            className="button"
            onClick={(event) => this.clickSetButton(event, 31)}
          >Last Month</div>
        </div>
